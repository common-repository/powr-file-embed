<?php
    ...
    Plugin URI: https://www.powr.io/plugins/file-embed
    ...
    */
    ...
    function powr_file_embed_options() {
      if(powr_local_mode()){//Determine JS url:
        $redirect_url = 'https://localhost:3000/wp-create/file-embed';
      }else{
        $redirect_url = 'https://www.powr.io/wp-create/file-embed';
      }
